...
const getLastAsupGestures = require("./routes/getLastAsupGestures");
const asupPDF = require("./routes/generateAsupPDF");
const smartemis = require("./routes/smartemis");
const histSmartemis = require("./routes/hist_Smartemis");
...
const demandeFormation = require("./routes/demandeFormation");
...
const peremptionsAll = require("./routes/peremptionsAll");
...
const getAgetByMatricule = require("./routes/getAgetByMatricule");
...
app.use("/getLastAsupGestures", getLastAsupGestures);
app.use("/asupPDF", asupPDF);
app.use("/smartemis", smartemis);
app.use("/hist_Smartemis", histSmartemis);
...
app.use("/demandeFormation", demandeFormation);
...
app.use("/peremptions_all", peremptionsAll);
...
app.use("/getAgetByMatricule", getAgetByMatricule);
