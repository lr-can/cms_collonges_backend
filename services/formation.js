...
async function generateTelex(data){
    ...
    // Appeler launchApp si data.launchApp est true
    if (data.launchApp === true) {
        try {
            await launchApp(data, numInter);
        } catch (err) {
            console.error('Error in launchApp:', err);
            // On continue même si launchApp échoue
        }
    }
    let htmlRender = '';
        ...
        if (adresseParticuliere != ""){
            ...
            <table class="T100 F14 noMargin">
                ...
                <tr>
                    ...
                    <td class="T30">
                        <span>:</span>
                        <span class="bold">${specialAddress.voie}</span>
                    </td>
                </tr>
            </table>`
            ...
            <table class="T100 F14 noMargin">
                ...
                <tr>
                    ...
                    <td class="T30">
                        <span>:</span>
                        <span class="bold">${adresses.adresseCommune.voie}</span>
                    </td>
                </tr>
            </table>
            <table class="T100 F14 noMargin">`;
               ...
               htmlRender += `
                <tr>
                    ...
                    <td class="T80 flexx">
                        ...
                        <span class="bold">${observation.replace(/\n/g, "<br>")}`;
