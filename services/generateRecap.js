...
async function getRecapCommande() {
    ...
    try {
        ...
        manquantKits = await kit.getMaterielManquantKits(4);
    } catch (err) {
        console.warn('getRecapCommande: kit.getMaterielManquantKits ignoré:', err.message);
    }
    const classique = await dataBase.query(
